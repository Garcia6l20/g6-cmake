option(G6_WARNINGS_AS_ERRORS "Treat compiler warnings as errors" OFF)
...
if(MSVC)
  set(G6_WARNINGS ${MSVC_WARNINGS})
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang" OR G6_ENABLE_CLANG_TIDY)
  set(G6_WARNINGS ${CLANG_WARNINGS})
else()
  set(G6_WARNINGS ${GCC_WARNINGS})
endif()

set(G6_WARNINGS
  ${G6_WARNINGS}
  CACHE INTERNAL "G6 warnings")

if(G6_SUPPRESS_WARNINGS)
  list(REMOVE_ITEM G6_WARNINGS ${G6_SUPPRESS_WARNINGS})
endif()
